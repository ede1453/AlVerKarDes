...
Write-Host "=== RC35.2 Event Test Isolation Validation ==="

Write-Host ""
Write-Host "=== Targeted tests ==="
python -m pytest tests/test_rc35_event_bus_service.py tests/test_rc352_event_test_isolation.py tests/test_rc351_event_repository_singleton.py tests/test_rc351_event_api_singleton_contract.py tests/test_rc351_provider_scheduler_event_visibility.py -q
...
Write-Host ""
Write-Host "=== Event isolation API smoke ==="
...
Write-Host ""
Write-Host "=== RC35.2 Event Test Isolation Validation Passed ==="
