...
class OpenAICompatibleProvider(BaseExternalLLMProvider):
    name = "openai"
    ...
    def _generate_external(self, request: LLMGatewayRequest) -> LLMGatewayResponse:
        return LLMGatewayResponse(
            ...
            metadata={
                "message": "OpenAI-compatible provider boundary is present, but network calls are not implemented in RC16.",
                "contract_ready": True,
            },
        )
