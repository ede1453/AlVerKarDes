...
- Her değişiklikten sonra gerçek PostgreSQL/Redis'e karşı test et, mock'a değil.
- Negatif kontrol yap: guard'ı/fix'i geçici kaldırıp bug'ın gerçekten var
  olduğunu göster, sonra geri koy.
- WIKI_ROOT (Obsidian vault) ilgili sayfalarını ve log.md'yi güncelle.
