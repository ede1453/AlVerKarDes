...
def test_alembic_history_is_linear():
    ...
    # (verified 2026-07-23: chain is genuinely linear, 0001->0024, this was
    # just stale after 0024_notification_outbox_items was added, also verified
    # clean end-to-end on a fresh throwaway database plus a downgrade/upgrade
    # roundtrip, not just this structural check).
    assert result["head"] == "0024_notification_outbox_items"
