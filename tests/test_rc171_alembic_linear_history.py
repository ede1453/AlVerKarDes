...
def test_alembic_history_is_linear():
    ...
    # (verified 2026-07-23: chain is genuinely linear, 0001->0022, this was
    # just stale after 0022_jobs was added, also verified clean end-to-end on
    # a fresh throwaway database plus a downgrade/upgrade roundtrip, not just
    # this structural check).
    assert result["head"] == "0022_jobs"
