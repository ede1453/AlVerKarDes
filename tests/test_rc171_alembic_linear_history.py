...
def test_alembic_history_is_linear():
    ...
    # (verified 2026-07-23: chain is genuinely linear, 0001->0025, this was
    # just stale after 0025_user_profiles was added, also verified clean
    # end-to-end on a fresh throwaway database plus a downgrade/upgrade
    # roundtrip, not just this structural check).
    assert result["head"] == "0025_user_profiles"
