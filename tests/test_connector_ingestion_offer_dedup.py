...
class FakeProductService:
    async def get_or_create_product(self, product_name: str, country: str = "DE"):
        return DummyProduct("11111111-1111-1111-1111-111111111111"), {"identity": "ok"}, False
...
class FakeMarketService:
    ...
    async def get_or_create_offer(self, payload):
        self.offer_calls += 1
        return DummyOffer("33333333-3333-3333-3333-333333333333"), self.offer_calls == 1
...
@pytest.mark.asyncio
async def test_connector_ingestion_sets_offer_created_flag():
    ...
    assert result.items[0].offer_created is True
